...
#define WALK_ASSIST_WHEEL_SPEED_PI_CONTROLLER_KP_DIVIDEND	100
#define WALK_ASSIST_WHEEL_SPEED_PI_CONTROLLER_KP_DIVISOR	4
#define WALK_ASSIST_WHEEL_SPEED_PI_CONTROLLER_KI_DIVIDEND	40
#define WALK_ASSIST_WHEEL_SPEED_PI_CONTROLLER_KI_DIVISOR	6
